...
/**
 * [As name suggest, this class is use to get the association document, to get
 * the asoociated profile, RoleName]
 * 
 * @author TSangmo
...
public class Association
{
	...
	/**
	 * [This function is use to get the profileName while opening the Employee
	 * document. to get default value]
	 * 
	...
	/**
	 * [This function is use to get the role Name while opening the Employee
	 * document. to get default value.]
	 * 
			...
			String newprofile)
	{
		if (!oldprofile.equals(newprofile))
		{
			...
			try
			{
				...
				//get has_a relation
				String relationId = getRelationDocUnid("HAS_A");
				String lookupkey1 = JSFUtil
						.getlookupkey(relationId, personunid);
				Vector tmp1 = new Vector();
				tmp1.add(lookupkey1);
	...
	/**
	 * [Delete the Person-Profile association document when the Employee is
	...
	/**
	 * [To delete the Employee and Person association document when the Employee
	 * is deleted by the Admin from the Employee view]
	 * 
