...
public class DynamicTable {
	...
	public  Document getviewProfile(){
		 sessionObj = Utility.getCurrentSession();
			View v1;
			try {
				servName = Utility.getCurrentDatabase().getServer();		
