...
public class TimeZoneUtil 
{
	...
	/**
	 *[This method return time zone in canonical format ]
	 *@param partialLabelCode as Time zone String ,for exmpale: GMT+5:30
	 *@param labelTranslateLocale as Locale
	 *@return time zone String in canonical format
	 */
	public static String getCononical(String partialLabelCode,Locale labelTranslateLocale)
	{	
		
		String[][] codeToLabel = getCodeToLabel(labelTranslateLocale);
		for (String[] codeAndLabel : codeToLabel) 
		{    // find the canonical time zone string basis on time zone GMT string
			if(codeAndLabel[1].contains(partialLabelCode))
			{ 
				return codeAndLabel[0];
	...
	/**
	 *[This method return human readable time zone String]
	 *@param canonicalTimeZone as String
	 *@return human readable time zone as String
	 */
	public static String getGMTString(String canonicalTimeZone)
	{	
		
		String[][] codeToLabel = getCodeToLabel(Utility.getXspContext().getLocale());
		for (String[] codeAndLabel : codeToLabel) 
		{   // get GMT time zone string basis on canonical time zone
			if(codeAndLabel[0].equals(canonicalTimeZone))
			{ 
