...
import bsuite.weber.jsonparsing.Entity;
import bsuite.weber.jsonparsing.Feature;
import bsuite.weber.jsonparsing.Field;
import bsuite.weber.jsonparsing.Module;
...
public class ProfileEdit {
	...
	/*public Database getDatabase(String dbName) {
		...
		try {
			...
			db = ExtLibUtil.getCurrentSession().getDatabase("", bsuitepath + dbName);
		} catch (NotesException e) {
