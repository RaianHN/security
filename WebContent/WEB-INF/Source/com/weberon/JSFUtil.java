...
public class JSFUtil {
	...
	/**
	 * Finds an HTML rendered id of the UIComponent by its component identifier
	 * in the component tree below the specified <code>topComponent</code> top
	 * component.
	 * 
	 * 
	 * @param compId
	...
	public static Object getApplciationComponent(String scopeid) {
		...
		Map applicationscope = (Map) JSFUtil
				.getVariableValue("applicationScope");
	...
	@SuppressWarnings("unchecked")
	private static Vector getColumnValue(String Dbname, String vwname,
			Vector key, int i) {
		Database db;
		...
		try {
			db = ExtLibUtil.getCurrentSession().getDatabase(
					"",
					BSUtil.getBsuitePath(ExtLibUtil.getCurrentDatabase())
							+ "relation.nsf");
			if (db == null) {
	...
	@SuppressWarnings("unchecked")
	private static Vector getallColumnValue(String Dbname, String vwname,
			Vector key, int i) {
		Database db;
